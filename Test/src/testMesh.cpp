...
void testMesh::setName(std::string _new)
{
  m_name = _new;
}

std::string testMesh::getName() const
{
  return m_name;
}

void testMesh::setID(size_t _new)
{
  m_id = _new;
}

size_t testMesh::getID() const
{
  return m_id;
}

void testMesh::test_setName()
{
